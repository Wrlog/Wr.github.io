...
(function (factory) {
  ...
  const menu = $.widget('ui.menu', {
    ...
    _filterMenuItems: function (character) {
      const escapedCharacter = character.replace(
        /[\-\[\]{}()*+?.,\\\^$|#\s]/g,
        '\\$&'
      )
  ...
  $.extend(Datepicker.prototype, {
    ...
    _setDate: function (inst, date, noChange) {
      ...
      const newDate = this._restrictMinMax(
        inst,
    ...
    _generateHTML: function (inst) {
      ...
      const currentDate = this._daylightSavingAdjust(
        !inst.currentDay
          ? new Date(9999, 9, 9)
          : new Date(inst.currentYear, inst.currentMonth, inst.currentDay)
      )
    ...
    _adjustInstDate: function (inst, offset, period) {
      ...
      const day =
        ...
        (period === 'D' ? offset : 0)
      const date = this._restrictMinMax(
        inst,
    ...
    _canAdjustMonth: function (inst, offset, curYear, curMonth) {
      const numMonths = this._getNumberOfMonths(inst)
      const date = this._daylightSavingAdjust(
        new Date(
          curYear,
  ...
  $.widget('ui.resizable', $.ui.mouse, {
    ...
    _change: {
      ...
      w: function (event, dx) {
        const cs = this.originalSize
        const sp = this.originalPosition
  ...
  $.ui.plugin.add('resizable', 'alsoResize', {
    ...
    resize: function (event, ui) {
      ...
      $(o.alsoResize).each(function () {
        const el = $(this)
        const start = $(this).data('ui-resizable-alsoresize')
        const style = {}
...
*/
  $.ui.ddmanager = {
    ...
    prepareOffsets: function (t, event) {
      ...
      const list = (t.currentItem || t.element)
        .find(':data(ui-droppable)')
        .addBack()
    ...
    each(spaces, function (spaceName, space) {
      ...
      each(props, function (key, prop) {
        ...
        color.fn[key] = function (value) {
          ...
          const fn =
            key === 'alpha' ? (this._hsla ? 'hsla' : 'rgba') : spaceName
          const local = this[fn]()
  ...
  const slider = $.widget('ui.slider', $.ui.mouse, {
    ...
    _createHandles: function () {
      ...
      let handleCount
      const options = this.options
      let existingHandles = this.element
