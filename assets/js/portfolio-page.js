// Enhanced JavaScript for Portfolio Page - Interactive Features
// Compiled from portfolio-page.ts

(function() {
    'use strict';
    
    var PortfolioPageEnhancer = /** @class */ (function () {
        ...
        PortfolioPageEnhancer.prototype.setupPublicationLinks = function () {
            ...
            pubLinks.forEach(function (link) {
                ...
                element.addEventListener('mouseleave', function () {
                    var tooltip = element.querySelector('.publication-tooltip');
                    if (tooltip)
                        tooltip.remove();
                });
            });
        ...
        PortfolioPageEnhancer.prototype.setupAwardAnimations = function () {
            var _this = this;
            var allListItems = document.querySelectorAll('.markdown-body ul li');
            var awards = [];
            ...
            var awardListItems = document.querySelectorAll('.awards-list li');
            awardListItems.forEach(function (li) { return awards.push(li); });
        ...
        PortfolioPageEnhancer.prototype.celebrateAward = function (element) {
            ...
            for (var i = 0; i < 5; i++) {
                setTimeout(function () {
                    ...
                    setTimeout(function () { return sparkle.remove(); }, 1000);
                }, i * 100);
            }
        };
        ...
        PortfolioPageEnhancer.prototype.setupShareButtons = function () {
            ...
            projectCards.forEach(function (card) {
                ...
                shareBtn.addEventListener('click', function () {
                    var _a;
                    var title = ((_a = card.querySelector('h3')) === null || _a === void 0 ? void 0 : _a.textContent) || '';
