...
!(function (root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') {
    ...
    const a = factory(
      typeof exports === 'object' ? require('Raphael') : root.Raphael
    )
  ...
  \******************/
    ...
    function (module, exports, __webpack_require__) {
      ...
      const parse = __webpack_require__(/*! ./src/flowchart.parse */ 4)
      __webpack_require__(/*! ./src/jquery-plugin */ 14)
      const FlowChart = {
        parse
      }
      typeof window !== 'undefined' && (window.flowchart = FlowChart),
  ...
  \**********************************/
    ...
    function (module, exports) {
      function _defaults (options, defaultOptions) {
        if (!options || typeof options === 'function') return defaultOptions
        const merged = {}
  ...
  \*********************************/
    ...
    function (module, exports, __webpack_require__) {
      ...
      const drawAPI = __webpack_require__(/*! ./flowchart.functions */ 3)
      const drawLine = drawAPI.drawLine
      const checkLineIntersection = drawAPI.checkLineIntersection;
      /* Gets the attribute based on Flowstate, Symbol-Name and default, first found wins */
      (Symbol.prototype.getAttr = function (attName) {
        if (this.chart) {
          let opt1
          const opt3 = this.chart.options
      ...
      (Symbol.prototype.drawLineTo = function (symbol, text, origin) {
        ...
        const y = this.getCenter().y
        const right = this.getRight()
        const bottom = this.getBottom()
        const left = this.getLeft()
        const symbolX = symbol.getCenter().x
        const symbolY = symbol.getCenter().y
        const symbolTop = symbol.getTop()
        const symbolRight = symbol.getRight()
        const symbolLeft = symbol.getLeft()
        const isOnSameColumn = x === symbolX
        const isOnSameLine = y === symbolY
        const isUnder = symbolY > y
        const isUpper = y > symbolY || this === symbol
        const isLeft = x > symbolX
        const isRight = symbolX > x
        let maxX = 0
        const lineLength = this.getAttr('line-length')
        const lineWith = this.getAttr('line-width')
        if ((origin && origin !== 'bottom') || !isOnSameColumn || !isUnder) {
          if ((origin && origin !== 'right') || !isOnSameLine || !isRight) {
            if ((origin && origin !== 'left') || !isOnSameLine || !isLeft) {
              if (
                (origin && origin !== 'right') ||
                  !isOnSameColumn ||
                  !isUpper
        ...
        // update line style
          ...
          for (let l = 0, llen = this.chart.lines.length; llen > l; l++) {
            for (
              var len,
  ...
  \************************************/
    ...
    function (module, exports) {
      function drawPath (chart, location, points) {
        ...
        let len
        let path = 'M{0},{1}'
        for (i = 2, len = 2 * points.length + 2; len > i; i += 2) {
          path += ' L{' + i + '},{' + (i + 1) + '}'
        }
      ...
      function drawLine (chart, from, to, text) {
        let i, len
        Object.prototype.toString.call(to) !== '[object Array]' && (to = [to])
        let path = 'M{0},{1}'
        for (i = 2, len = 2 * to.length + 2; len > i; i += 2) {
          path += ' L{' + i + '},{' + (i + 1) + '}'
        }
        const pathValues = [from.x, from.y]
        for (i = 0, len = to.length; len > i; i++) {
  ...
  \********************************/
    ...
    function (module, exports, __webpack_require__) {
      function parse (input) {
        ...
        for (let l = 1, len = lines.length; len > l;) {
        ...
        for (; lines.length > 0;) {
          const line = lines.splice(0, 1)[0].trim()
          if (line.indexOf('=>') >= 0) {
            // definition
            ...
            if (params && params.length > 1) {
              for (
                ...
                entry.length == 2 && (symbol.params[entry[0]] = entry[1])
              }
            }
            var sub
            ...
            for (
              ...
              if (i + 1 != lenS) {
                const curSymb = getSymbol(lineStyleSymbols[i])
      ...
      var Operation = __webpack_require__(
        /*! ./flowchart.symbol.operation */ 11
      )
      var InputOutput = __webpack_require__(
        /*! ./flowchart.symbol.inputoutput */ 10
      )
      var Subroutine = __webpack_require__(
        /*! ./flowchart.symbol.subroutine */ 13
      )
      var Condition = __webpack_require__(
  ...
  \*******************************************/
    ...
    function (module, exports, __webpack_require__) {
      ...
      const inherits = __webpack_require__(
        /*! ./flowchart.helpers */ 1
      ).inherits
      const drawAPI = __webpack_require__(/*! ./flowchart.functions */ 3)
  ...
  \********************************/
    ...
    function (module, exports, __webpack_require__) {
      ...
      const Condition = __webpack_require__(
        /*! ./flowchart.symbol.condition */ 5
      );
      ...
      (FlowChart.prototype.render = function () {
        ...
        let minX = 0
        let minY = 0
        for (i = 0, len = this.symbols.length; len > i; i++) {
  ...
  \******************************/
    ...
    function (module, exports, __webpack_require__) {
      if (typeof jQuery !== 'undefined') {
        const parse = __webpack_require__(/*! ./flowchart.parse */ 4)
        !(function ($) {
          $.fn.flowChart = function (options) {
            return this.each(function () {
              const $this = $(this)
              const chart = parse($this.text())
